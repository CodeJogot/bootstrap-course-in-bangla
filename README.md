...
Bootstrap এর পুরো Course টিকে ৬ টি ভাগে ভাগ করা হয়েছে। নিচে Course Design টা Table আঁকারে দেয়া হলো।
...
- Body তে `font-size: 1rem` সেট করা থাকে। অর্থাৎ যদি html element এ base font-size যদি 16px হয়, তাহলে body তেও সেই 16px থেকে যায়।
- Body তে globally একটা `font-family`, `font-weight`, `line-height`, `background-color` (`#fff`) এবং `color` সেট করা হয়।
...
- Bootstrap দিয়ে Accordion তৈরি করতে যে যে Classes এবং Attributes লাগে তা নিচে দেয়া হলোঃ

## Bootstrap Alerts

- Bootstrap দিয়ে Alerts তৈরি করতে যে যে Classes এবং Attributes লাগে তা নিচে দেয়া হলোঃ

| No. | Class              | Attribute       | Reason                                                                                                 |
| --- | ------------------ | --------------- | ------------------------------------------------------------------------------------------------------ |
| 1   | alert              |                 | alert তৈরি করার জন্য।                                                                                  |
| 2   | alert-primary      |                 | alert এর Color দেয়ার জন্য।                                                                             |
| 3   |                    | role            | alert টা কি Role play করছে সেটা বলে দেয়ার জন্য।                                                        |
| 4   | btn-close          |                 | Button টা কি Type এর Button, সেটা বলে দেয়ার জন্য।                                                      |
| 5   |                    | data-bs-dismiss | Close Button টাকে Workable করার জন্য।                                                                  |
| 6   | alert-dismissiable |                 | Close Button টা ডান পাশে নেবার জন্য।                                                                   |
| 7   | fade and show      |                 | Alert টা Smoothly চলে যায়, সেজন্য এই দুইটা ক্লাস একসাথে ব্যবহার করতে হয়।                               |
...
- Bootstrap দিয়ে Breadcrumb তৈরি করতে যে যে Classes এবং Attributes লাগে তা নিচে দেয়া হলোঃ
...
- Bootstrap দিয়ে Button তৈরি করতে যে যে Classes এবং Attributes লাগে তা নিচে দেয়া হলোঃ

| **No.** | **Class**           | **Attribute**  | **Reason**                                                                                                                                          |
| ------- | ------------------- | -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1       | btn                 |                | Bootstrap Button তৈরি করার জন্য।                                                                                                                    |
| 2       |                     | type           | Element টা যে একটা Button Type সেটা বলে দেয়ার জন্য।                                                                                                 |
| 3       | btn-primary         |                | Button এর কালার দেয়ার জন্য।                                                                                                                         |
...
- Bootstrap দিয়ে Button Group তৈরি করতে যে যে Classes এবং Attributes লাগে তা নিচে দেয়া হলোঃ
...
| 5       |                            | data-bs-ride="carousel" | Carousel autoplay হওয়ার জন্য                                                                                                                         |
